...
codepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  return codepage.messages(null, null, opt_ijData) + '<script type="text/javascript" src="./js/blockly_compressed.js"><\/script><script type="text/javascript" src="./js/field_checkbox.js"><\/script><script type="text/javascript" src="./js/blocks_compressed.js"><\/script><script type="text/javascript" src="./js/msg/js/en.js"><\/script><script type="text/javascript" src="./js/blocks_tinker.js?001"><\/script><script type="text/javascript" src="./js/language/javascript_compressed.js"><\/script><script type="text/javascript" src="./js/language/gogocode.js?dde"><\/script><script type="text/javascript" src="./js/language/bytecode.js?001"><\/script><script type="text/javascript" src="./js/' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><table width="100%" height="100%"><tr><td><h1><!--<span id="title"><a href="../index.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '"></a>Tinker - GogoBoard Status : </span> --></h1></td><td class="farSide"><select id="languageMenu" style="display: none;"></select></td></tr><tr><td colspan=2><table width="100%"><tr id="tabRow" height="1em"><td id="tab_blocks" class="tabon">Visual blocks</td><td class="tabmin">&nbsp;</td><td class="tabmin">&nbsp;</td><td id="tab_gogocode" class="taboff">Logo text-programming</td><td class="tabmax"><button id="trashButton" class="notext hide" title="Discard all blocks."><img src=\'./media/1x1.gif\' class="trash icon21"></button> <button id="linkButton" class="hide notext" title="Save and link to blocks."><img src=\'./media/1x1.gif\' class="link icon21"></button> <button id="runButton" class="disabled" title="Run the program defined by the blocks in the workspace."><img src=\'./media/1x1.gif\' class="run icon21"></button><input type="file" id="loadXML" accept="text/xml" style="display: none;"/><button id="loadButton" class="hide" title="Load xml blocks into the workspace.">Open</button><input type="file" id="importXML" accept="text/xml" style="display: none;"/><button id="importButton" class="hide" title="Load and import xml blocks into the workspace.">Import</button><button id="saveButton" class="hide" title="Save blocks as xml file from the workspace.">Save</button><button id="runStopButton" class="" title="Simulatly press a run button on the board.">Run/Stop</button><button id="writeButton" class=" primary" title="Write the program defined by the blocks to Gogo Board.">Download to Board</button></td></tr></table></td></tr><tr><td height="99%" colspan=2 id="content_area">' + codepage.toolbox(null, null, opt_ijData) + '</td></tr></table><div id="content_blocks" class="content"></div><div id="content_gogomon" class="content"></div><pre id="content_gogocode" class="content" contenteditable="true"></pre><div id="content_cdi" class="content"></div><div id="content_cvi" class="content"></div><textarea id="content_xml" class="content" wrap="off"></textarea>' + apps.dialog(null, null, opt_ijData) + apps.storageDialog(null, null, opt_ijData);
};
